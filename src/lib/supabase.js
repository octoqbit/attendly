...
const supabaseUrl = localStorage.getItem('attendly_supabase_url') || DEFAULT_SUPABASE_URL;
const supabaseAnonKey = localStorage.getItem('attendly_supabase_key') || DEFAULT_SUPABASE_ANON_KEY;
