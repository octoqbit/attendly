...
-- ============================================================
-- ADMIN & APPROVAL MIGRATION (RUN THIS!)
-- ============================================================
-- 1. Update Role Constraint (Allow 'admin')
-- ALTER TABLE users DROP CONSTRAINT IF EXISTS users_role_check;
-- ALTER TABLE users ADD CONSTRAINT users_role_check CHECK (role IN ('student', 'faculty', 'admin'));

-- 2. Add is_approved column (default true for existing users)
-- ALTER TABLE users ADD COLUMN IF NOT EXISTS is_approved BOOLEAN DEFAULT TRUE;

-- 3. (Optional) Create the first Admin manually:
-- INSERT INTO auth.users (id, email) VALUES ('some-uuid', 'admin@attendly.com'); 
-- INSERT INTO users (id, email, name, role, is_approved) VALUES ('some-uuid', 'admin@attendly.com', 'Super Admin', 'admin', TRUE);